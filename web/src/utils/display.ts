...
export function translateCode(
  ...
  const catalog = (getLanguage() === "en-US" ? enUS : zhCN)[
    namespace
...
export const directionText = (value: unknown) =>
  translateCode("direction", value);
export const classificationText = (value: unknown) =>
  translateCode("classification", value);
export const zoneText = (value: unknown) => translateCode("zone", value);
export const integrationTypeText = (value: unknown) =>
  translateCode("integrationType", value);
export const checkTypeText = (value: unknown) =>
  translateCode("checkType", value);
